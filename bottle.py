...
class Router(object):
    ...
    def match(self, environ):
        ...
        methods = ('PROXY', 'HEAD', 'GET', 'ANY') if verb == 'HEAD' else (
        'PROXY', verb, 'ANY')
...
class ConfigDict(dict):
    ...
    __slots__ = (
    '_meta', '_change_listener', '_overlays', '_virtual_keys', '_source', '__weakref__')
...
class _MultipartPart(object):
    ...
    def finish_header(self):
        ...
        self.content_type, options = _parse_http_header(content_type)[
            0] if content_type else (None, {})
...
class BaseTemplate(object):
    ...
    def search(cls, name, lookup=None):
        ...
        if not lookup:
            raise depr(0, 12, "Empty template lookup path.",
...
class SimpleTemplate(BaseTemplate):
    ...
    def code(self):
        ...
        try:
            ...
            raise depr(0, 11, 'Unsupported template encodings.',
