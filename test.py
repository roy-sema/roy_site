            ...
            class DjangoObjectPermissions(DjangoModelPermissions):
                ...
                class DjangoObjectPermissions(DjangoModelPermissions):
                    ...
                    class OperandHolder(OperationHolderMixin):
                        ...
                        def __hash__(self):
                            return hash(
                                (self.operator_class, self.op1_class, self.op2_class))
                    ...
                    class DjangoObjectPermissions(DjangoModelPermissions):
                        ...
                        class AND:
                            ...
                            def has_object_permission(self, request, view, obj):
                                return (
                                        self.op1.has_object_permission(request, view,
                                                                       obj) and
                                        self.op2.has_object_permission(request, view, obj)
                                )
                        ...
                        class OR:
                            ...
                            def has_object_permission(self, request, view, obj):
                                return (
                                        self.op1.has_permission(request, view)
                                        and self.op1.has_object_permission(request, view,
                                                                           obj)
                                ) or (
                                        self.op2.has_permission(request, view)
                                        and self.op2.has_object_permission(request, view,
                                                                           obj)
                                )
                        ...
                        class NOT:
                            ...
                            def has_object_permission(self, request, view, obj):
                                return not self.op1.has_object_permission(request, view,
                                                                          obj)
